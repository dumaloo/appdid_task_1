import 'package:appdid_task/recipe/random_meal_provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:share_plus/share_plus.dart';

class RandomMealScreen extends ConsumerWidget {
  const RandomMealScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final recipe = ref.watch(randomMealNotifierProvider);
    return Scaffold(
      appBar: AppBar(
        title: Text("Random Meal: Recipe"),
      ),
      body: recipe.when(
        data: (data) {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Center(
                          child:
                              Text("Meal Category: ${data[0]["strCategory"]}")),
                      ElevatedButton(
                          onPressed: () {
                            Share.share(
